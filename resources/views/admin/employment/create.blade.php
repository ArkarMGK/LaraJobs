                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="active tab-pane" id="activity">
                            <form action="{{ route('admin#storeEmployment') }}" method="POST">
                                @csrf
                                <div class="p-4">
                                    <label for="employmentType">New Employment Type</label>
                                    {{-- NOTE. name="employment_type" to be the same value as database Attribute --}}
                                    <input type="text" name="employment_type" id="employmentType" class="mt-4 form-control"
                                ...
                                <div class="p-4">
                                    <input type="submit" value="Create" class="ms-4 btn btn-success">
                                </div>
                            </form>
                        </div>
                    </div>
